 ...
 * editing it.
 */
public class NoteEditAppCompat extends ActionBarActivity {
	...
	protected Dialog onCreateDialog(int id) {
		...
		case EXIT:
			return new MaterialDialogBuilder(this)
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (theme) {
			...
			menu.add(0, SEND_ID, 0, R.string.menu_send)
					.setIcon(IconTintFactory
                            .setLightMaterialColor(R.drawable.ic_share_black_48dp,
			...
			menu.add(0, SEND_ID, 0, R.string.menu_send)
                    .setIcon(IconTintFactory
                            .setDarkMaterialColor(R.drawable.ic_share_black_48dp,
                                    NoteEditAppCompat.this))					.setShowAsActionFlags(
                    MenuItemCompat.SHOW_AS_ACTION_IF_ROOM
                            | MenuItemCompat.SHOW_AS_ACTION_WITH_TEXT);
